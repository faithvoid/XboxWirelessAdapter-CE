...
def respond_to_handshake(packet, socket, local_mac):
    ...
    response = bytes.fromhex("43 6F 72 74 61 6E 61 20 57 69 72 65 6C 65 73 73 20 41 64 61 70 74 65 72 00 00 00 00 00 00 00 00 76 30 2E 31 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 06 07 00 00 0F FE 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 05 01 A9 FE 47 79 01 02 01 0B 02 0C 31 31 31 31 31 31 31 31 31 31 31 31 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 02 01 00 00")
